...
| **Demo Video URL** | *[Insert Unlisted YouTube URL]* | Narration & `whoami`/`hostname` terminal verification |
...
| **2** | Task 2 — Demo Video | 15 | **15** | Demo video with voice narration showing terminal `whoami`/`hostname` and Playwright test executions. |
| **3** | Agent Skills & Audit | 10 | **10** | Executed strictly via `WORKFLOW.md` and `SKILLS.md`. Generated full `AI_AUDIT_LOG.md` and `RAW_AUDIT_LOG.json`. |
| | **TOTAL** | **100** | **100** | Full compliance with all HW04 requirements, zero evidence fabrication, 100% black-box integrity. |
