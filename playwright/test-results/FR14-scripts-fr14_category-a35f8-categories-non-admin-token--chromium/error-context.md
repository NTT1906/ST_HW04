...
- Name: FR14\scripts\fr14_category.spec.js >> FR-14 — Category Management CRUD (Data-Driven) >> TC-DT-011: Regular user cannot access/modify categories (non-admin token)
